...
@Tag(name = "Manager — Tournament Finance", description = "Manager quản lý thu/chi giải đấu (ngoài tiền đăng ký)")
@SecurityRequirement(name = "bearerAuth")
@RestController
@RequestMapping("/api/v1/manager/tournaments/{id}/finance")
@RequiredArgsConstructor
public class ManagerTournamentFinanceController {
